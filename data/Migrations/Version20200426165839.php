 ...
 */
final class Version20200426165839 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE client (id INT NOT NULL, name VARCHAR(255) NOT NULL, phone VARCHAR(16) DEFAULT NULL, email VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
